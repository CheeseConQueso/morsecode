...
*/
//20140408
//code from /home/besthome/public_html/10SurfRoad.com/morse/rttl2mid.php
//BEGINCODE
...
$img_dir = "http://www.10surfroad.com/morse/_img/";

//Header
echo '<center><font face="arial black" size=3 color="orange"><b>::';
//echo '<a href="http://www.10surfroad.com/morse/x.php" style="text-dec oration:none;">';
...
{	
	...
	if($tabs==1)
	{
		...
		$tab_fullpath 	= 	'http://www.10surfroad.com/morse/_tabs/'.$phrase.'.txt';
		$midi_fullpath 	= 	'http://www.10surfroad.com/morse/_midi/'.$phrase.'.mid';	
...
/*
	...
	*/
	...
	echo '<center>';
	echo '<font face="arial black" size=5><b><a href="'.$file.'">Download the MIDI for '.$phrase.'</a></b></font><br>';
